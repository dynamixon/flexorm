 ...
 * @date 23-12-29
 */
@Table(value = "logic_table_A",autoColumnDetection = false)
@Data
public class LogicTableA {
    @PodamExclude
    @Primary
    @Column("id")
    private Long id;
    ...
    @PodamStringValue(length = 50)
    @Column("all_lower_getter")
    private String allLowerGetter;

    public String getalllowergetter() {
        return allLowerGetter;
    }
}
